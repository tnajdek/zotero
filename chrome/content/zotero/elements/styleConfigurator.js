...

{
		...
		content = MozXULElement.parseXULToFragment(`
			...
			>
				...
				<div id="style-selector-wrapper">
					<xul:styleselector id="style-selector" value="${this.getAttribute('style') || Zotero.Prefs.get('export.lastStyle') || ''}" />
				</div>
	...
	customElements.define('localeselector', LocaleSelector);
	customElements.define('styleselector', StyleSelector);
	customElements.define('styleconfigurator', StyleConfigurator);
}
