...
var require = (function() {
	...
	const makePath = chrPath => (win.Zotero?.componentDev
			? `file://${win.Zotero.componentDev}/chrome/${chrPath.replace('zotero/content/', 'content/zotero/')}`
			: `chrome://${chrPath}`);
	const paths = {
		'': 'resource://zotero/',
		'containers/': makePath('zotero/content/containers/'),
		'components/': makePath('zotero/content/components/'),
		'hooks/': makePath('zotero/content/hooks/'),
